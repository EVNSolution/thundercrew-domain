...
function bikeIconSvg(wheelType?: string): string {
  ...
  // 배송 스쿠터(자체 제작 — 핸들·기울인 컬럼·데크·도넛 바퀴 2·후방 배달박스)
  // 로 바꾼 변형. 도넛 바퀴는 evenodd 구멍이라 28px 에서도 바퀴로 읽힌다.
  const inner =
    wheelType === "FOUR_WHEEL"
      ...
      : '<rect x="14" y="2.6" width="7.4" height="6.8" rx="1.3"/>' +
        '<rect x="16.9" y="9.4" width="1.8" height="5.8"/>' +
        '<rect x="2" y="4.4" width="4.4" height="1.9" rx="0.95"/>' +
        '<path d="M4.2 6.3 L6.3 5.8 L9 13.3 L6.7 13.9 Z"/>' +
        '<path d="M5 13.3 H16 C17.4 13.3 18.4 14 18.7 15.2 L18.9 15.8 H3.5 C3.3 14.6 3.9 13.3 5 13.3 Z"/>' +
        '<path fill-rule="evenodd" d="M6 15.6 A2.6 2.6 0 1 0 6 20.8 A2.6 2.6 0 1 0 6 15.6 Z M6 17.15 A1.05 1.05 0 1 1 6 19.25 A1.05 1.05 0 1 1 6 17.15 Z"/>' +
        '<path fill-rule="evenodd" d="M18 15.6 A2.6 2.6 0 1 0 18 20.8 A2.6 2.6 0 1 0 18 15.6 Z M18 17.15 A1.05 1.05 0 1 1 18 19.25 A1.05 1.05 0 1 1 18 17.15 Z"/>';
  // 28px 마커에서 실루엣이 뭉개지지 않게 글리프별 배치 — 스쿠터는 bbox
  // (19.4×18.2, 중심 11.7,11.7)를 0.70 로 키워 원(중심 12, r10.5) 재중심.
  const placement =
    wheelType === "FOUR_WHEEL"
      ? 'translate(5.2 5.2) scale(0.5667)'
      : 'translate(3.8 3.8) scale(0.70)';
  return (
